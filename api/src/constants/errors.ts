export class ErrorConstants {
  ...
  public static readonly VALIDATION_BODY_USERTYPE =
    'The request body is missing the userType field.';
  ...
  public static readonly VALIDATION_BODY_NUM_HOURS_REDUCED =
    'The field numHoursReduced is missing in the request';
  ...
  public static readonly VALIDATION_BODY_REQUESTID =
    'The requestId is missing in the request.';
}
