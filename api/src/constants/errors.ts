export class ErrorConstants {
    ...
    public static readonly VALIDATION_STUDENTNUMBER_NONNUM = "The student number contains non numeric characters."
    public static readonly VALIDATION_STUDENTNUMBER_LENGTH = "The student number must be 8 digits."
