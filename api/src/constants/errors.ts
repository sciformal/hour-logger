export class ErrorConstants {
    ...
    public static readonly VALIDATION_BODY_CHECKIN = "The request body is missing the check in field";
    public static readonly VALIDATION_BODY_CHECKOUT = "The request body is missing the check out field";
