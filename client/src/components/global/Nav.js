          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav>
              <NavDropdown id="hours-dropdown" title="Hours">
                ...
                <NavDropdown.Item href="/reduction">Hour Reduction</NavDropdown.Item>

                {(type === "ADMIN" || type === "MANAGER" || type === "COMMS") && (
                <NavDropdown.Item href="/check-in">Volunteer Check-In</NavDropdown.Item>
                )}

                {type === "ADMIN" && (
                  <NavDropdown.Item href="/edit-hours">Edit Hours</NavDropdown.Item>
                )}
              </NavDropdown>
